...
CREATE TABLE `wp_comments` (
  ...
  `comment_author_192.168.99.238` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
INSERT INTO `wp_comments` (`comment_ID`, `comment_post_ID`, `comment_author`, `comment_author_email`, `comment_author_url`, `comment_author_192.168.99.238`, `comment_date`, `comment_date_gmt`, `comment_content`, `comment_karma`, `comment_approved`, `comment_agent`, `comment_type`, `comment_parent`, `user_id`) VALUES
...
(1, 'siteurl', 'https://192.168.99.103:5050', 'yes'),
(2, 'home', 'https://192.168.99.103:5050', 'yes'),
